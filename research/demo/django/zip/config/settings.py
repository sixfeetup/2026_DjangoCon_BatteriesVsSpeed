...
# Database
#############################################################################
DATABASE_URL_ERRORS = (ImproperlyConfigured, environs.EnvError)
try:
    DATABASES = {"default": env.dj_db_url("DATABASE_URL")}
except DATABASE_URL_ERRORS:
    DATABASES = {
        "default": {
...
DRAMATIQ_RESULT_BACKEND = {
    ...
    "BACKEND_OPTIONS": {
        "url": f"redis://{REDIS_HOST}:{REDIS_PORT}/2",
    },
...
DJANGO_VITE = {
    "default": {
        "dev_mode": env.bool("DJANGO_VITE_DEV_MODE", default=DEBUG or TESTING),
        "dev_server_protocol": env.str(
            "DJANGO_VITE_DEV_SERVER_PROTOCOL", default="http"
        ),
        ...
        "static_url_prefix": "",
        "manifest_path": BASE_DIR.joinpath("vite-manifest.json").as_posix(),
    }
}

...
class RedisZipRepository:
    ...
    def lookup(self, prefix: str, limit: int = 10) -> list[ZipEntry]:
        members = self._client.zrange(
    ...
    def is_ready(self) -> bool:
        ...
        ping_result, cardinality, metadata = pipe.execute()
        ...
        return (
            count == str(self._settings.expected_count)
            and sha256 == self._settings.expected_sha256
        )
